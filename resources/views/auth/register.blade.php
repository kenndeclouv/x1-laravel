...
@section('content')
    {{-- <img src="{{ asset('assets/img/landing/hero-8.png') }}" alt=""
            ...
            <div class="authentication-inner py-6">
                ...
                <div class="card" style="background-color: rgba(var(--bs-body-bg-rgb), 0.8); backdrop-filter: blur(10px);">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1 minecraft-ten-v2">Join with {{ config('app.name') }}!</h4>
                        <p class="mb-6">Please register to create your account and start your adventure!</p>

                        <form id="formAuthentication" class="mb-4" action="{{ route('register.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="alert alert-primary">
                                <p>Make sure your gamertag is the same as the one you use on the server.</p>
                            </div>
                            <div class="mb-6 form-control-validation">
                                <label for="name" class="form-label">Minecraft Gamertag </label>
                            ...
                            <div class="mb-6 form-password-toggle form-control-validation">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password_confirmation" class="form-control"
                                        ...
                                        placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                                        aria-describedby="password_confirmation" value="" />
                                    <span class="input-group-text cursor-pointer"><i
                                            class="icon-base ti tabler-eye-off"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="mt-4">
                                @if (request('url'))
                                    <p>Already have an account? <a href="{{ route('login', ['url' => request('url')]) }}"
                                            class="text-primary">Sign in</a></p>
                                @else
                                    <p>Already have an account? <a href="{{ route('login') }}" class="text-primary">Sign
                                            in</a></p>
                                @endif
                            </div>
                        </form>
